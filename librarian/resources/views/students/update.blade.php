    ...
    <div class="card-body">
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="student_code" value="{{$student->student_code}}" class="form-control" id="student_code" placeholder="Enter student code">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="birthday" value="{{$student->birthday}}" class="form-control" id="birthday" placeholder="Enter Birthday">
            </div>
