    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label style="font-weight: bolder" for="exampleInputPassword1" class="form-label">Email</label>
                ...
                <div class="mb-3">
                    <label style="font-weight: bolder" for="exampleInputPassword1" class="form-label">Mật khẩu</label>
                ...
                <div class="mb-3">
                    <label style="font-weight: bolder" for="exampleInputPassword1" class="form-label">Ngày sinh</label>
                ...
                <div class="mb-3">
                    <label style="font-weight: bolder" for="exampleInputPassword1" class="form-label">Số điện thoại</label>
                ...
                <div class="mb-3">
                    <label style="font-weight: bolder" for="exampleInputPassword1" class="form-label">Ảnh</label>
